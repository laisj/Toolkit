...
object topad_display_click {
  def main(args: Array[String]) {
    ...
    sc.parallelize(topAds, 1).saveAsTextFile("training_pipeline/displayDebug/" + suffix + "/topAds")
    sc.parallelize(topAdsCpc, 1).saveAsTextFile("training_pipeline/displayDebug/" + suffix + "/topAdsCpc")
    sc.parallelize(adsDebugBuf, 1).saveAsTextFile("training_pipeline/displayDebug/" + suffix + "/adsDebugBuf")
  }
}
